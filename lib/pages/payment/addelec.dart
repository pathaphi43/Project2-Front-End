...
class AddElecPage extends StatefulWidget {
  AddElecPage({key}) : super(key: key);

  @override
  State<AddElecPage> createState() => _AddElecPageState();
}
var formatter = new DateFormat('dd-MM-yyyy');

class _AddElecPageState extends State<AddElecPage> {
  @override
           ...
           Container(
             child: Column(
              children: [
                ...
                Text("งวดค่าไฟ",style: TextStyle(color: Color.fromRGBO(250, 120, 186, 1),fontSize: 20)),
                        TextButton.icon(
