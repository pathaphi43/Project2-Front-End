...
class _PreRentState extends State<PreRent> {
                    ...
                    children: <Widget>[
                      (snapshot.hasData)
                          ? Column(
                              ...
                              return _getSlidableWithLists(context, e);
                            }).toList())
                          : Container()
                    ],
                  ),
  ...
  Widget _getSlidableWithLists(BuildContext context, HouseAndImageModel e) {
    return Slidable(
      closeOnScroll: true,
      // key:ValueKey(e.hid),
                ...
                Row(
                  children: <Widget>[
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        e.houseDistrict == null ? "" : " อ." + e.houseDistrict,
                        style: TextStyle(
                          color: Color.fromRGBO(250, 120, 186, 1),
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
