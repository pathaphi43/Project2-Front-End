    ...
    return Scaffold(
      ...
      body: Container(
        child: ListView(
          ...
          children: [
            Center(child: Text('คะแนน',style: _appStyle.textStyleUrSize(20),)),
            SizedBox(height: 20),
            Center(
                  ...
                  Padding(
                    ...
                    child: new FlatButton(
                      ...
                      onPressed: () async{
                        ...
                        model.reviewsText =textFormField.text.isEmpty ? null:textFormField.text;
                        ...
                        http.MultipartRequest('POST', postUri)
                         ...
                         if( files!= null){
                           for(File file in files){
                             ...
                             request.files.add(await http.MultipartFile.fromBytes('file', await File.fromUri(file.uri).readAsBytes(),filename: fileName,contentType: MediaType('ContentType', 'application/json')));
                           }
                         }
